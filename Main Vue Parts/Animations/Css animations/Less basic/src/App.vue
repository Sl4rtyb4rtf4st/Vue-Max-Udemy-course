  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <button class="btn btn-primary" @click="show4 = !show4">Mixed alert</button>
        <br><br>        
        <transition name="mix" appear>
          <div class="alert alert-success" v-if="show4">
            Using the <strong>appear</strong> key-word in the transition element makes the element animate on pageload
          </div>
        </transition>
        <hr>
        <button class="btn btn-primary" @click="show5 = !show5">Custom classes alert</button>
        <br><br>
        <transition name="mix" 
          enter-active-class="animated flipInX"
          leave-active-class="animated flipOutX"
          appear>
          <div class="alert alert-success" v-if="show5">
            Using the <strong>appear</strong> key-word in the transition element makes the element animate on pageload
          </div>
        </transition>
        <hr>
        ...
        <button class="btn btn-primary" @click="show6 = !show6">Custom classes alert</button>
        <br><br>
        <transition :name="alertAnimation">
          <div class="alert alert-success" v-if="show6">
            Using the <strong>appear</strong> key-word in the transition element makes the element animate on pageload
          </div>
        </transition>
        <hr>
